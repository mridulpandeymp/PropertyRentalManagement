...
<head>
   <meta charset="UTF-8">
    ...
    <title>${tenantProfile.firstName} Profile</title>
...
<div class="content">
 <%
                User tenantProfile = (User) request.getAttribute("tenantProfile");
            %>
 
	<h1>${tenantProfile.firstName} Profile</h1>
	<table>
		<tr>
			<td>First Name:</td>
			<td>${tenantProfile.firstName}</td>
		</tr>
		<tr>
			<td>Last Name:</td>
			<td>${tenantProfile.lastName}</td>
		</tr>
		<tr>
			<td>Email ID:</td>
			<td>${tenantProfile.emailId}</td>
		</tr>
		<tr>
			<td>Mobile No:</td>
			<td>${tenantProfile.mobileNo}</td>
		</tr>
		<tr>
			<td>Date of Birth:</td>
			<td>${tenantProfile.dateOfBirth}</td>
		</tr>
		<tr>
			<td>Username:</td>
			<td>${tenantProfile.username}</td>
		</tr>
